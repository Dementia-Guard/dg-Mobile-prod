...
class DayTodayFragment : Fragment() {
    ...
    companion object {
        fun newInstance(question: Question, difficultyLevel: Int, currentQuestionIndex: Int, allQuestionAmount: Int) = DayTodayFragment().apply {
